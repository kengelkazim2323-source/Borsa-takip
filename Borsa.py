...
# ==========================================
clock_html = f"""
<div style="position: fixed; top: 20px; right: 20px; background: {t_sec['box']}; padding: 10px 20px; border-radius: 50px; box-shadow: 0 4px 15px rgba(0,0,0,0.4); z-index: 99999; display: flex; align-items: center; gap: 15px; border: 2px solid {t_sec['accent']};">
